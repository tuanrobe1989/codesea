...
function add_theme_scripts()
{
    ...
    //REGISTER STYLES
    wp_enqueue_style('styles', get_stylesheet_directory_uri() . '/dist/css/styles.css', array(), $my_theme->get('Version'), 'all');
    //REGISTER SCRIPTS
    wp_register_script('script', get_stylesheet_directory_uri() . '/dist/js/scripts.js', array('jquery'), $my_theme->get('Version'), true);
    $global_params = array(
