...
tpfObjects.coverHbsptFormPopups = function () {
  ...
  jQuery('.sgpb-popup-dialog-main-div-wrapper .hs-form-iframe').each(function () {
    if (jQuery(this).hasClass('actived') == false) {
      ...
      var head = jQuery(this).contents().find("head"); //var body = jQuery(this).contents().find("body");
      ...
      if (jQuery(this).contents().find('#coverhsform').length == 0 && jQuery(this).contents().find('#coverhsform-2').length == 0) {
        ...
        var css2 = "<link id='coverhsform-2' rel='stylesheet' href='" + global_params.themes_url + "/dist/css/cover_iframe_background.css?ver=" + version + "' id='cover_iframe_bg_form' type='text/css' media='all' />"; // var js = "<script type='text/javascript' src='" + global_params.themes_url + "/dist/js/cover_iframe.js?ver=" + version + "' id='cover_iframe'></script>"
...
tpfObjects.coverHbsptForm = function () {
  jQuery('.content .hs-form-iframe').each(function () {
    if (jQuery(this).hasClass('actived') == false) {
      ...
      var css2 = "<link rel='stylesheet' href='" + global_params.themes_url + "/dist/css/cover_iframe_background.css?ver=" + version + "' id='cover_iframe_bg_form' type='text/css' media='all' />"; // var js = "<script type='text/javascript' src='" + global_params.themes_url + "/dist/js/cover_iframe.js?ver=" + version + "' id='cover_iframe'></script>"
...
jQuery(document).ready(function ($) {
  ...
  jQuery('iframe').load(function () {
    jQuery('iframe').contents().find("head").append(jQuery("<style type='text/css'>  .label{color: red !important}  </style>"));
  });
